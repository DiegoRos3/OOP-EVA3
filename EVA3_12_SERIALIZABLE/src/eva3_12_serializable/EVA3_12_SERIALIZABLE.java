...
public class EVA3_12_SERIALIZABLE {
    ...
    public static void main(String[] args) {
        ...
        Persona perso = new Persona("Diego", "Rose", 666);
        try {
            guardarObj(perso);
    ...
    public static void guardarObj(Persona perso) throws IOException {
        FileOutputStream abrirArchivo = new FileOutputStream("C:\\archivostec\\personas.per");
    ...
    public static Persona leerObjetos() throws IOException, ClassNotFoundException {
        Persona perso = null;
        FileInputStream abrirArchivo = new FileInputStream("C:\\archivostec\\personas.per");
